...
class BuddiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buddy" do
    assert_difference('Buddy.count') do
      post buddies_url, params: { buddy: { email: @buddy.email, first_name: @buddy.first_name, last_name: @buddy.last_name, phone: @buddy.phone, twitter: @buddy.twitter } }
    end
  ...
  test "should update buddy" do
    patch buddy_url(@buddy), params: { buddy: { email: @buddy.email, first_name: @buddy.first_name, last_name: @buddy.last_name, phone: @buddy.phone, twitter: @buddy.twitter } }
